...
\subsection{Evaluation of Options}
These are the three most used free web-servers provided by the open source community that will allow of to remotely connect via mobile web-browser through IP address. 
\subsection{Options Comparison}
