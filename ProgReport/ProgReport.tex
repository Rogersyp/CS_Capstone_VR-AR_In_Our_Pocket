...
\begin{center}
	...
	&We are going to be relying on eachother early next term to give us a run down of each of our three subjects. We need to set aside time to teach eachother about our three aspects because if one of us falls behind a long the way it will drag down the rest of us. But this term has proven that we are all capable of doing what we need to do and we can rely on each other to provide accurate and well thoughout information. \\ \hline
    \end{tabular}
\end{center}
